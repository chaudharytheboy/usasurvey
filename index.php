            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body" style="padding-left:25px;padding-right:25px; padding-bottom:25px;">
                        ...
                        <script>
                        var msg =
                            '<font size = "3"><strong>Congratulations Amazon Shopper!</strong></font><br><br>You have been chosen to participate in a short, anonymous survey regarding your experiences with <b>Amazon.</b><br><div class="fb-wrapper" id="fb-wrapper" style="width: 80vw; max-width:600px; overflow:hidden;display:none;"><br><div class="fb-like" data-href="https://www.facebook.com/facebook/" data-layout="standard" data-action="recommend" data-size="small" data-show-faces="true" data-width="400" data-share="false"><\/div><\/div><br>Once you have completed this quick survey, you will be offered a few exclusive rewards <strong>(valued at $50.00 or more)</strong> for providing us with valuable consumer data.<br><br>This survey is available today: <strong>$date</strong><br><br>';
                        var msg2 = msg.replace("$date", datehax());
                        document.write(msg2);
                        </script>
                        <font size="3"><strong>Congratulations <span class="amazon-color">Amazon</span>
                                Shopper!</strong></font><br><br>You have been chosen to participate in a short,
                        anonymous survey regarding your experiences with <b><span
                                class="amazon-color">Amazon</span>.</b><br>
                        <!--	  <span>
                        ...
                        <div class="fb-wrapper" id="fb-wrapper"
                            style="width: 80vw; max-width:600px; overflow:hidden;display:none;"><br>
                            <div class="fb-like fb_iframe_widget" data-href="https://www.facebook.com/facebook/"
                                data-layout="standard" data-action="recommend" data-size="small" data-show-faces="true"
                                data-width="400" data-share="false" fb-xfbml-state="rendered"
                                fb-iframe-plugin-query="action=recommend&amp;app_id=405670262806154&amp;container_width=0&amp;href=https%3A%2F%2Fwww.facebook.com%2Ffacebook%2F&amp;layout=standard&amp;locale=en_US&amp;sdk=joey&amp;share=false&amp;show_faces=true&amp;size=small&amp;width=400">
                                <span style="vertical-align: bottom; width: 400px; height: 28px;"><iframe
                                        name="f12e17e1380aec8" width="400px" height="1000px" frameborder="0"
                                        allowtransparency="true" allowfullscreen="true" scrolling="no"
                                        allow="encrypted-media" title="fb:like Facebook Social Plugin"
                                        src="https://www.facebook.com/v2.9/plugins/like.php?action=recommend&amp;app_id=405670262806154&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fconnect%2Fxd_arbiter%2Fr%2Fd_vbiawPdxB.js%3Fversion%3D44%23cb%3Df2b0aa7ba3cfb38%26domain%3Dglobalsurveyscenter.com%26origin%3Dhttps%253A%252F%252Fglobalsurveyscenter.com%252Ff16be9f1f724bb%26relation%3Dparent.parent&amp;container_width=0&amp;href=https%3A%2F%2Fwww.facebook.com%2Ffacebook%2F&amp;layout=standard&amp;locale=en_US&amp;sdk=joey&amp;share=false&amp;show_faces=true&amp;size=small&amp;width=400"
                                        class=""
                                        style="border: none; visibility: visible; width: 400px; height: 28px;"></iframe></span>
                            </div>
                        </div><br>Once you have completed this quick survey, you will be offered a few exclusive rewards
                        <strong>(valued at $50.00 or more)</strong> for providing us with valuable consumer
                        data.<br><br>This survey is available today: <strong><span id="datetime"> March 26,
                                2019</strong><br><br>
                        ...
                        <p></p><!-- Audio -->
                        <button id="modalbutton" style="background: ;color: ;" type="button" class="btn-lg  btn-start"
                            data-dismiss="modal">Start Survey</button>
                    </div>
                    <!--
						   <script type="text/javascript">
                ...
                <div class="row reviewboxbuttons">
                    <div class="col-sm-12">
                        ...
                        <div id="2" style="display:none">
                            ...
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">I'm Not
                                Sure</button>
                        </div>

                        <div id="3" style="display:none">
                            <div class="question-count center_q">Question 3 of 8</div>
                            <div class="question center_q">How would you rate your overall satisfaction with Amazon?
                            </div>
                        ...
                        <div id="4" style="display:none">
                            ...
                            <div class="question center_q">Do you follow Amazon on any social media websites, such as
                                Facebook, Twitter, Instagram, or Pinterest?</div>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">Yes</button>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">No</button>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">I'm Not
                                Sure</button>
                        ...
                        <div id="5" style="display:none">
                            ...
                            <div class="question center_q">What is the the most important thing to you when shopping
                                online?</div>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">Convenience</button>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">Product
                                selection</button>
                            ...
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">Shipping
                                speed</button>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">All of the
                                above</button>
                        ...
                        <div id="6" style="display:none">
                            ...
                            <div class="question center_q">What type of device do you most often use to shop online?
                            </div>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">Desktop/Laptop
                                computer</button>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">Tablet</button>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">Mobile
                                phone</button>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">Other</button>
                        </div>
                        ...
                        <div id="7" style="display:none">
                            ...
                            <div class="question center_q">Are the products that you buy from Amazon usually in-stock at
                                the time of purchase?</div>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">Yes, almost
                                always</button>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">Yes, most of the
                                time</button>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">No, I usually have
                                to wait</button>
                            <button id="q1a" type="button" class="sv_btn" onclick="goToNext(this);">No, I almost always
                                have to wait</button>
                        </div>

                        <div id="8" style="display:none">
                            <div class="question-count center_q">Question 8 of 8</div>
                            <div class="question center_q">Last but not least, how likely are you to recommend Amazon to
                                a friend?</div>
                            ...
                            <button id="q1a" type="button" class="sv_btn" onclick="last(this);">Neither likely nor
                                unlikely</button>
                            <button id="q1a" type="button" class="sv_btn" onclick="last(this);">Somewhat
                                unlikely</button>
                        ...
                        <div id="loading-img" style="display:none">
                            ...
                            <p>While we submit your answers, we are searching our inventory to see which products we can
                                offer you as a <b>thank you</b> for completing the survey.</p>
                        ...
                        <div id="results" style="display:none">
                            ...
                            <div class="media well well-sm">
                                ...
                                <div class="media-body">
                                    ...
                                    <font size="5"><strong>Thank you for completing the Amazon survey!</strong></font>
                                    <br><br>To show our appreciation for providing us with extremely valuable consumer
                                    data, you may now choose <b>(1)</b> of the following exclusive products
                                    below.<br><br>Please note that due to extremely HIGH demand, there is a limited
                                    supply of these rewards in stock.<br>
                                    <!-- <a href="#"><img src="images/fb-button.png" class="img-responsive" style="display:block;padding-bottom: 0px;"></a>
							<a href="#"><img src="images/fb-img1.png" class="img-responsive"></a>
							<a href="#"><img src="images/fb-img2.png" class="img-responsive"></a>
							<a href="#"><img src="images/fb-img3.png" class="img-responsive"></a>
							...
							<a href="#"><img src="images/fb-img12.png" class="img-responsive"></a>-->
                                    ...
                                    <div class="fb-wrapper" id="fb-wrapper2"
                                        style="width: 80vw; max-width:600px; overflow:hidden;display:none;"><br>
                                        <div class="fb-like fb_iframe_widget"
                                            data-href="https://www.facebook.com/facebook/" data-layout="standard"
                                            data-action="recommend" data-size="small" data-show-faces="true"
                                            data-width="400" data-share="false" fb-xfbml-state="rendered"
                                            fb-iframe-plugin-query="action=recommend&amp;app_id=405670262806154&amp;container_width=0&amp;href=https%3A%2F%2Fwww.facebook.com%2Ffacebook%2F&amp;layout=standard&amp;locale=en_US&amp;sdk=joey&amp;share=false&amp;show_faces=true&amp;size=small&amp;width=400">
                                            <span style="vertical-align: bottom; width: 400px; height: 28px;"><iframe
                                                    name="f3592bff85d3ae4" width="400px" height="1000px" frameborder="0"
                                                    allowtransparency="true" allowfullscreen="true" scrolling="no"
                                                    allow="encrypted-media" title="fb:like Facebook Social Plugin"
                                                    src="https://www.facebook.com/v2.9/plugins/like.php?action=recommend&amp;app_id=405670262806154&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fconnect%2Fxd_arbiter%2Fr%2Fd_vbiawPdxB.js%3Fversion%3D44%23cb%3Df2c1330106ce7dc%26domain%3Dglobalsurveyscenter.com%26origin%3Dhttps%253A%252F%252Fglobalsurveyscenter.com%252Ff2d2696d413906%26relation%3Dparent.parent&amp;container_width=0&amp;href=https%3A%2F%2Fwww.facebook.com%2Ffacebook%2F&amp;layout=standard&amp;locale=en_US&amp;sdk=joey&amp;share=false&amp;show_faces=true&amp;size=small&amp;width=400"
                                                    class=""
                                                    style="border: none; visibility: visible; width: 400px; height: 28px;"></iframe></span>
                                        </div>
                                    </div><br>Special offer available today: <strong><span id="datetime2"> March 26,
                                            2019</strong><br><br>Coupon code: <span
                                        style="background-color: #FFFF00">"<strong>AMAZONSURVEY</strong>"</span> has
                                    been applied for reduced shipping costs.
                                </div>
                            </div>
                            <div id="offers">
                            ...
                            ?>
								...
								<hr>
							            ...
							            <div class="col-md-3 text-center"> <br>
                                            ...
                                            {                                               
                                            ?>
                                                <a href="https://www.goodsdirecttoday.com/d/fsr/02.00/04/?AFID=171134&SID={affiliate_id}&click_id=786883088&C1={affiliate_id}&C2={transaction_id}&C3="
                                                    target="_blank">
                                                    <img id="offer_img_1" class="img-responsive"
                                                        style="max-width: 130px; margin: 0 auto;"
                                                        src="<?php echo $row['images'];?>" alt="..."
                                                        onclick="ViewOffer_1();">
                                                </a>
                                          ...
                                          ?>
                                            ...
                                            <div class="col-md-5 text-center" style="color: black;"> <br>
                                                ...
                                                <br> Regular Price: <strike>
                                                    $<?php echo $row['regular_price'];?></strike> <br> Your Price: <font
                                                    color="#008000"><strong
                                                        style="background-color: yellow;">$<?php echo $row['product_price']?>*</strong>
                                                </font><br> Shipping:
                                                <strong>$<?php echo $row['shipping']?></strong><br> Quantity Remaining:
                                                (<font color="#FF0000"><?php echo $row['quantity'];?></font>)<br> <br>
                                                <span class=" quantity"> <span class="label label-danger">1</span>
                                                </span>
                                            </div>
                                            ...
                                            <a  id="<?php echo $row['url_1'];?>" class="remove_link">
                                                <button id="claim_btn_1" onclick="ViewOffer_1();"
                                                        style="cursor:pointer;font-size: 1.2em; color: black; margin:auto auto; width:100%; max-height:40px;background: ;color: ;"
                                    ...
                                    <div id="offer_main_div_9" class="col-md-12 item sex_female" data-name="female"
                                        ...
                                        <div class="row offer-row"
                                            ...
                                            <div class="col-md-3 text-center"> <br><img id="offer_img_9"
                                                    ...
                                                    src="images/ecig_oos_1.png" alt="..." onclick="ViewOffer_9();">
                                                <div class="reviewitem" style="color:#164d96;"><img id="star_img_9"
                                                        ...
                                                        onclick="ViewOffer_9();">(293)</a></div> <br>
                                            </div>
                                            <div class="col-md-5 text-center" style="color: black;"> <br> <strong>
                                                    <font size="3"><u>E-CIGS™ Pro Vapor</u></font>
                                                </strong><br><b>Exclusive vape starter kit. Includes everything you need
                                                    to quit cigarettes forever!</b> <br> Regular Price: <strike>
                                                    $169.95</strike> <br> Your Price: <font color="#008000"><strong
                                                        style="background-color: yellow;">$0.00*</strong></font><br>
                                                Shipping: <strong>$4.95</strong><br> Quantity Remaining: (<font
                                            ...
                                            <div id="claim_btn_div_9" class="col-md-4 height:100%;">
                                                <font color="red">**<b>Currently Out Of Stock**</b></font>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <ul class="list-group">
                                <li class="media list-group-item2">
                                    ...
                                    <div class="media-body">
                                        <p class="media-heading comment-name">Sydney F.<span class="comment-time">
                                                <script>
                                                r_comment_date(1);
                                                </script>25 March, 2019 at 11:51 PM
                                            </span></p>
                                        <p class="comment-body">I was just checking my e-mail on my phone and then saw
                                            the survey. I ended up choosing the CBD oil at the end. I have one friend
                                            who told me it helps his joint pain, and another who says it has really
                                            helped de-stress her. I think it might be the placebo effect, but it's still
                                            worth a shot right? Fingers crossed!</p>
                                    </div>
                                </li>
                                <li class="media list-group-item2">
                                    <img class="media-object pull-left" src="images/test_2.gif" alt="...">
                                    <div class="media-body">
                                        <p class="media-heading comment-name">Kathryn A.<span class="comment-time">
                                                <script>
                                                r_comment_date(1);
                                                </script>25 March, 2019 at 10:47 AM
                                            </span></p>
                                        <p class="comment-body">My cousin told me about this "keto supplement" she's
                                            been taking that she's lost a ton of weight with, but it was too expensive
                                            for me to try on a single-mom budget. Then I randomly see it as an option on
                                            here, so I guess I'll take that as a sign from the universe lol. It must be
                                            really popular. I hope it works for me too! :)</p>
                                    </div>
                                </li>
                                <li class="media list-group-item2">
                                    <img class="media-object pull-left" src="images/test_3.gif" alt="...">
                                    <div class="media-body">
                                        <p class="media-heading comment-name">Noah O.<span class="comment-time">
                                                <script>
                                                r_comment_date(2);
                                                </script>24 March, 2019 at 3:39 pm
                                            </span></p>
                                        <p class="comment-body">I took the survey about a week ago but am just now
                                            leaving my comment because I wanted to wait to see if I actually would
                                            receive anything for real. Well, I chose the skin cream and just got it in
                                            the mail. I gave it to my girlfriend and she loves it so far. Just wanted to
                                            share my experience. Thanks! -Tony</p>
                                    </div>
                                </li>
                                <li class="media list-group-item2">
                                    <img class="media-object pull-left" src="images/f55.gif" alt="...">
                                    <div class="media-body">
                                        <p class="media-heading comment-name">Adam W.<span class="comment-time">
                                                <script>
                                                r_comment_date(4);
                                                </script>22 March, 2019 at 8:08 PM
                                            </span></p>
                                        <p class="comment-body">So let me just say....I got a text asking me to
                                            participate in this survey and I was extremely skeptical at first. I
                                            mean....who wouldn't be? I thought the products that would be offered to me
                                            would be trash but I selected the flashlight and waited to see if it would
                                            arrive. Well, this thing just got here and honestly as crazy as it sounds,
                                            this thing is AWESOME! I highly recommend this survey to everyone, and thank
                                            you for taking my opinion into consideration!</p>
                                    </div>
                                </li>
                                <li class="media list-group-item2">
                                    <img class="media-object pull-left" src="images/test_4.gif" alt="...">
                                    <div class="media-body">
                                        <p class="media-heading comment-name">Susan S.<span class="comment-time">
                                                <script>
                                                r_comment_date(5);
                                                </script>21 March, 2019 at 8:47 am
                                            </span></p>
                                        <p class="comment-body">I was just doing some shopping online and got a
                                            notification for the survey. I figured I'd give it a shot. I received the
                                            uh... "male supplement" a few days later and gave it to my boyfriend. Let me
                                            just say...I am one happy lady!!! ;-)</p>
                                    </div>
                                </li>
                                    ...
                                    -->
                                                ...
                                                <div class="col-md-6">
                                                    <button id="commentbutton"
                                                        style="font-size: 1.2em; color: black; margin:auto auto; width:100%; max-height:40px;background:; "
                                                        class="text-center btn-lg click_claim_btn">Submit</button>
                                                </div>
                                                <script type="text/javascript">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-6">
                            <div class="review">
                                ...
                                <p>I've got a boring office job, so sometimes I like to take these just for fun or when
                                    I need a break. I used to be in marketing, so I find this approach of gathering
                                    consumer data very interesting. It's obviously working though, so I would definitely
                                    recommend taking a few!
                                </p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="review">
                                ...
                                <p>I don't usually take surveys online and I've never taken one like this before, but
                                    after answering the questions, I was very pleased with the offers I was presented
                                    with. I can't believe all I had to do was just share my honest opinion lol. I'm not
                                    sure if they'll be super happy with my responses but....whatever! :P
                                </p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="review">
                                ...
                                <p>I'm still in college so I decided to give mine to my mom. They didn't really have
                                    anything else I wanted. But now she looks younger than me, haha! Just kidding! For
                                    real though she is really happy and definitely has a glow to her. Thanks a ton! xoxo
                                </p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="review">
                                ...
                                <p>Oh boy.....just got mine in the mail today. I am shocked how fast it got here. Can I
                                    take any more of these surveys? I took this one a few days ago from an email I got.
                                    I'll DEFINITELY be on the lookout for more! Thanks! -Seth
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="survey-container">
            <div id="terms">
                ...
                <font size="1.5">©2019 All Rights Reserved. <br>
                    <br>THIS IS AN INDEPENDENT SURVEY. This website is not affiliated with or endorsed by Amazon and
                    does not claim to represent or own any of the trademarks, tradenames or rights associated with any
                    of the products which are the property of their respective owners who do not own, endorse, or
                    promote globalsurveyscenter.com. All images on globalsurveyscenter.com are readily available in
                    various places on the Internet and believed to be in public domain according to the U.S. Copyright
                    Fair Use Act (title 17, U.S. Code). *Free trial offers offered require shipping and handling fees.
                    See manufacturer's site for details as terms vary with offers. See important terms and conditions
                    regarding this survey, site and advertisement
                    <a href="terms-conditions.html" rel="nofollow"
                        onclick="window.open('../../../terms-conditions.html', 'Terms','width=550,height=500,scrollbars=yes,resizable=yes'); return false;">here.</a><br><br>
                    *Risk-free trial. You will be billed an amount specified in the offer's T&amp;C after the trial
                    period ends, unless you call to cancel.<br>This is an advertisement. The free trial offers available
                    on this page pay this website for orders placed. Once you decide to select an offer, keep in mind
                    you will be billed an amount described in the offer's terms &amp; conditions after the trial period
                    ends unless you call to cancel. Depending on the offer, you may also be billed every 30 days for a
                    new delivery of the product (you may cancel any time by calling the merchant).<br>
                    *Free trial offers require shipping and handling fees. See manufacturer's site for details as terms
                    vary with offers.<br>
                </font>
            </div>
            </font>
